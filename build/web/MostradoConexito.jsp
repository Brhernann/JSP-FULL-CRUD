...
<html>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td><font color="blue"><b>Rut</b></font> </td>
    ...
    <c:forEach var="a" items="${sessionScope.Usuarios}">
        ...
        <td>${a.getRut()}</td>
        <td>${a.getEdad()}</td>
        <td><a href="eliminar.do?txteliminar=${a.rut}"><center><img src="eliminar.png"/> </center></a></td>
        <td><a href="validar.do?txtmod=${a.rut}"><center><img src="modificar.png"/> </center></a></td>
